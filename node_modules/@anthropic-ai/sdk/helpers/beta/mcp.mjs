...
import { SDK_HELPER_SYMBOL, collectStainlessHelpers, stainlessHelperHeader, } from "../../internal/stainless-helper-header.mjs";
 ...
 */
export var UnsupportedMCPValueError = /* @__PURE__ */ (() => {
    // -----------------------------------------------------------------------------
    // Error classes
    // -----------------------------------------------------------------------------
    /**
    ...
    return UnsupportedMCPValueError;
})();
// -----------------------------------------------------------------------------
// Helper functions
// -----------------------------------------------------------------------------
