...
import { WorkspaceAddParams, WorkspaceListParams, WorkspaceRemoveParams, WorkspaceRemoveResponse, Workspaces } from "./workspaces.mjs";
...
export declare class Rules extends APIResource {
     ...
     * ```
     */
    retrieve(federationRuleID: string, params?: RuleRetrieveParams | null | undefined, options?: RequestOptions): APIPromise<BetaFederationRule>;
    /**
     * **Requires an OAuth access token with the `org:admin` scope**, from
     * `ant auth login --scope org:admin` or a workload identity federation rule; Admin
     * API keys are not accepted. See
     ...
     * ```
     */
    update(federationRuleID: string, params: RuleUpdateParams, options?: RequestOptions): APIPromise<BetaFederationRule>;
    /**
     * **Requires an OAuth access token with the `org:admin` scope**, from
     * `ant auth login --scope org:admin` or a workload identity federation rule; Admin
     * API keys are not accepted. See
     ...
     * ```
     */
    list(params?: RuleListParams | null | undefined, options?: RequestOptions): PagePromise<BetaFederationRulesPageCursor, BetaFederationRule>;
    /**
     * **Requires an OAuth access token with the `org:admin` scope**, from
     * `ant auth login --scope org:admin` or a workload identity federation rule; Admin
     * API keys are not accepted. See
     ...
     * ```
     */
    archive(federationRuleID: string, params?: RuleArchiveParams | null | undefined, options?: RequestOptions): APIPromise<BetaFederationRule>;
}
...
export declare namespace Rules {
    export { type BetaFederationRule as BetaFederationRule, type BetaFederationRuleMatch as BetaFederationRuleMatch, type BetaFederationRuleWorkspace as BetaFederationRuleWorkspace, type BetaServiceAccountTarget as BetaServiceAccountTarget, type BetaFederationRulesPageCursor as BetaFederationRulesPageCursor, type RuleCreateParams as RuleCreateParams, type RuleRetrieveParams as RuleRetrieveParams, type RuleUpdateParams as RuleUpdateParams, type RuleListParams as RuleListParams, type RuleArchiveParams as RuleArchiveParams, };
