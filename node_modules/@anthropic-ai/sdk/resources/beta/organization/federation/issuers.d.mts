...
export declare class Issuers extends APIResource {
    /**
     ...
     * ```
     */
    retrieve(federationIssuerID: string, params?: IssuerRetrieveParams | null | undefined, options?: RequestOptions): APIPromise<BetaFederationIssuer>;
    /**
     * **Requires an OAuth access token with the `org:admin` scope**, from
     * `ant auth login --scope org:admin` or a workload identity federation rule; Admin
     * API keys are not accepted. See
     ...
     * ```
     */
    update(federationIssuerID: string, params: IssuerUpdateParams, options?: RequestOptions): APIPromise<BetaFederationIssuer>;
    /**
     * **Requires an OAuth access token with the `org:admin` scope**, from
     * `ant auth login --scope org:admin` or a workload identity federation rule; Admin
     * API keys are not accepted. See
     ...
     * ```
     */
    list(params?: IssuerListParams | null | undefined, options?: RequestOptions): PagePromise<BetaFederationIssuersPageCursor, BetaFederationIssuer>;
    /**
     * **Requires an OAuth access token with the `org:admin` scope**, from
     * `ant auth login --scope org:admin` or a workload identity federation rule; Admin
     * API keys are not accepted. See
     ...
     * ```
     */
    archive(federationIssuerID: string, params?: IssuerArchiveParams | null | undefined, options?: RequestOptions): APIPromise<BetaFederationIssuer>;
}
