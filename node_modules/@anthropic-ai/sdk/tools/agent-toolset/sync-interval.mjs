 ...
 */
export const DEFAULT_MEMORY_SYNC_INTERVAL_MS = 15000;
/**
 ...
 * changed.
 */
export const MIN_MEMORY_SYNC_INTERVAL_MS = 5000;
...
export function checkMemorySyncInterval(ms, option) {
    if (!(ms >= MIN_MEMORY_SYNC_INTERVAL_MS)) {
        throw new AnthropicError(`${option} must be at least ${MIN_MEMORY_SYNC_INTERVAL_MS}ms (got ${ms}); ` +
