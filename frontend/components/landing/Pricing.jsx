...
const PLANS = [
  {
    ...
    highlight: false,
    items: ["Painel com gráfico em tempo real", "Cotações de EURUSD, EURJPY e Ouro", "Calendário econômico", "3 mensagens por dia com a IA"]
  },
  {
    name: "VIP",
    tag: "Mais completo",
    ...
    highlight: true,
    items: ["Tudo do plano Free", "Sinais da IA para EURUSD, EURJPY e Ouro (M1 e M5)", "Indicador bwalpha + contagem do próximo candle", "Assistente de IA ilimitado", "Cancele quando quiser pelo painel"]
  }
];
